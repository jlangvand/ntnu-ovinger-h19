import no.iskra.oving4.Currency;
...
class valuta {
  ...
  public static void main(String[] args) {
    nok = new no.iskra.oving4.Currency("Norske kroner", "NOK", 1);
    usd = new no.iskra.oving4.Currency("Amerikanske dollar", "USD", 7.5);
    sek = new no.iskra.oving4.Currency("Svenske kronor", "SEK", 0.93);
